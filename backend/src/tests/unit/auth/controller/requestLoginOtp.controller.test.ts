...
describe("AuthController.loginWithPassword", () => {
  ...
  beforeEach(() => {
    jest.resetAllMocks();
    (requestOtpSchema.parse as jest.Mock)
  ...
  it("should return 200 on success", async () => {
    ...
    mockedAuthService.prototype.requestLoginOtp
    ...
    await AuthController.requestLoginOtp(req, res, next);

    expect(mockedAuthService.prototype.requestLoginOtp)
