...
describe("AuthController.loginWithOtp", () => {
  let req: any;
  let res: any;
  let next: jest.Mock;
  ...
  beforeEach(() => {
    jest.resetAllMocks();
    (loginOtpSchema.parse as jest.Mock)
  ...
  it("should return 200 on success", async () => {
    ...
    mockedAuthService.prototype.loginWithOtp
    ...
    await AuthController.loginWithOtp(req, res, next);

    expect(mockedAuthService.prototype.loginWithOtp)
