...
describe("AuthController.signupRecruiter", () => {
  let req: any;
  let res: any;
  let next: jest.Mock;
  ...
  beforeEach(() => {
    jest.resetAllMocks();
    (signupRecruiterSchema.parse as jest.Mock)
  ...
  it("should return 201 on success", async () => {
    ...
    mockedAuthService.prototype.signupRecruiter
    ...
    expect(mockedAuthService.prototype.signupRecruiter)
